...
<Nonce><![CDATA[%s]]></Nonce>
     ...
     * 	)
     * 参数说明
     * 1、group_id：用户分组id，可通过用户分组管理接口获取
     * 2、sex：性别：男（1）女（2），不填则不做匹配
     * 3、client_platform_type：客户端版本，当前只具体到系统型号：IOS(1), Android(2),Others(3)，不填则不做匹配
     * 4、country：国家信息，是用户在微信中设置的地区，具体请参考地区信息表
     * 5、province：省份信息，是用户在微信中设置的地区，具体请参考地区信息表
     * 6、city：城市信息，是用户在微信中设置的地区，具体请参考地区信息表
     * 7、language：语言信息，是用户在微信中设置的语言，具体请参考语言表
	 */
